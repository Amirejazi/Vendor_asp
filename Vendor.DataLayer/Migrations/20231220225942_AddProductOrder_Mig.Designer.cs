...
namespace Vendor.DataLayer.Migrations
{
    ...
    [Migration("20231220225942_AddProductOrder_Mig")]
    partial class AddProductOrder_Mig
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vendor.DataLayer.Entities.ProductOrder.Order", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Vendor.DataLayer.Entities.ProductOrder.OrderDetail", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Vendor.DataLayer.Entities.ProductOrder.OrderDetail", b =>
                {
                    b.HasOne("Vendor.DataLayer.Entities.ProductOrder.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Vendor.DataLayer.Entities.Product.ProductColor", "ProductColor")
                        .WithMany("OrderDetails")
